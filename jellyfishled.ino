...
// signed val to indicate x/y velocity
...
void loop() {
  ...
  EVERY_N_MILLISECONDS( 100 ) { calculateAngles(); } // calculate tilt angles
  EVERY_N_MILLISECONDS( 105 ) { detectJump(); } // calculate tilt angles
  EVERY_N_MILLISECONDS( 110 ) { applyPhysics(); } // apply jump velocity to calculated angles
...
void detectJump(){
//  jumpVelocity = 0; // @todo Calculate this based on accelerometer readings
}
